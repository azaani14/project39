...
function setup() {
  ...
  mario = createSprite(50,windowHeight-90,20,50);
  mario.addAnimation("running", mario_running);
  mario.scale = 0.5;
  
  ground = createSprite(windowWidth,windowHeight-70,1200,10);
...
function spawnCoin() {
  ...
  if (frameCount % 60 === 0) {
    var coin = createSprite(windowWidth,windowHeight-100,40,10);
